...
INSERT INTO `restaurant`.`dish_category` (`id`, `name`) VALUES ('1', 'pizza');
INSERT INTO `restaurant`.`dish_category` (`id`, `name`) VALUES ('2', 'dessert');
INSERT INTO `restaurant`.`dish_category` (`id`, `name`) VALUES ('3', 'vine');


INSERT INTO `restaurant`.`dish` (`name`, `price`, `category_id`) VALUES ('pizza napolitana', '5', '1');
INSERT INTO `restaurant`.`dish` (`name`, `price`, `category_id`) VALUES ('pizza venezzia', '8', '1');
INSERT INTO `restaurant`.`dish` (`name`, `price`, `category_id`) VALUES ('tiramisu', '3', '2');
INSERT INTO `restaurant`.`dish` (`name`, `price`, `category_id`) VALUES ('chianti', '12', '3');
